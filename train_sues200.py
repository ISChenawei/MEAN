...
class Configuration:
    def __init__(self):
        ...
        parser.add_argument('--ckpt_path',
                            default='checkpoints/university/convnext_tiny.fb_in22k_ft_in1k_384/best satetille-drone/weights_e1_0.9658.pth',
                            type=str, help='path to pretrained checkpoint file')

        # Model Config
        parser.add_argument('--nclasses', default=150, type=int, help='sues-200数据集的场景类别数')
        ...
        parser.add_argument('--weight_dsa', default=0.75, type=float)
        ...
        parser.add_argument('--data_folder', default='sample4geo/dataset', type=str)
