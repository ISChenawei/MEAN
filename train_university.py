...
class Configuration:
    def __init__(self):
        ...
        parser.add_argument('--model', default='convnext_tiny.fb_in22k_ft_in1k_384', type=str, help='backbone model')
        ...
        parser.add_argument('--weight_dsa', default=1.3, type=float)

        # --
        parser.add_argument('--only_test', default=False, type=bool, help='use pretrained model to test')
        parser.add_argument('--ckpt_path',
                            default='checkpoints/university/convnext_tiny.fb_in22k_ft_in1k_384/best-D-S-1012193451/weights_e1_0.9239.pth',
        ...
        parser.add_argument('--data_folder', default=r'D:\DL\UCRVS\sample4geo\dataset', type=str)
        parser.add_argument('--dataset_name', default='U1652', type=str)
        parser.add_argument('--dataset_name1', default='SUES-200', type=str)
        parser.add_argument('--altitude', default=250, type=int, help="150|200|250|300")
...
#     config.query_folder_train = f'{config.data_folder}/{config.dataset_name}/train/satellite'
#     config.gallery_folder_train = f'{config.data_folder}/{config.dataset_name}/train/drone'
#     config.query_folder_test = f'{config.data_folder}/{config.dataset_name1}/Testing/{config.altitude}/query_drone'
#     config.gallery_folder_test = f'{config.data_folder}/{config.dataset_name1}/Testing/{config.altitude}/gallery_satellite'
# elif config.dataset == 'U1652-S2D':
#     config.query_folder_train = f'{config.data_folder}/{config.dataset_name}/train/satellite'
#     config.gallery_folder_train = f'{config.data_folder}/{config.dataset_name}/train/drone'
#     config.query_folder_test = f'{config.data_folder}/{config.dataset_name1}/Testing/{config.altitude}/query_satellite'
#     config.gallery_folder_test = f'{config.data_folder}/{config.dataset_name1}/Testing/{config.altitude}/gallery_drone'
if __name__ == '__main__':
    ...
    if config.only_test:
        ...
        # if 1:
        #     del checkpoint['model_1.classifier1.classifier.weight']
        #     del checkpoint['model_1.classifier1.classifier.bias']
        #     del checkpoint['model_1.classifier_mcb1.classifier.weight']
        #     del checkpoint['model_1.classifier_mcb1.classifier.bias']
        #     del checkpoint['model_1.classifier_mcb2.classifier.weight']
        #     del checkpoint['model_1.classifier_mcb2.classifier.bias']
